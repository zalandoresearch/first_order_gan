...
def get_loader(root, dataset_name, batch_size, scale_size, data_format, split=None, is_grayscale=False, seed=None):
    assert dataset_name in ['celebA', 'lsun', 'cifar10'], str(dataset_name) + ' is not in ' + str(['celebA', 'lsun', 'cifar10'])
    ...
    if dataset_name == "lsun":
      ...
      if dataset_name == 'cifar10':
        print('getting cifar')
        paths = glob(os.path.join(root, "*/*.png"))
      else:
    ...
    return tf.to_float(queue) / 127.5 - 1., paths
